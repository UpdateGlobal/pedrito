        	...
        	<div class="container">
        		<div class="container-inner">
        			<ul>
        				...
        				<li class="category83">
        					<strong>Comida para Gatos</strong>
        				</li>
        			</ul>
        		</div>
        	</div>
			...
			<div class="col-left sidebar col-lg-3 col-md-3 col-sm-12 col-xs-12"><div class="block block-layered-nav">
                <div class="block-title">
                    ...
                    <div class="block-content">
                        <p class="block-subtitle">Selecciona tu Producto</p>
                        <dl id="narrow-by-list">
                         <div class="layered-attribute">
    						...
    						<dd>
                                <ol>
                                    <li>
                                        <a class="ajaxLayer">Categoría 1</a> 
                                    </li>
                                    <li>
                                        <a class="ajaxLayer">Categoría 1</a> 
                                    </li>
        ...
        <div class="pager">
            ...
            <div class="pages">
                ...
                <ol>
                    ...
                    <li><a href="#">2</a></li>
                    <li><a class="next i-next" href="#" title="Next">
						...
						<div class="des">
                            ...
                            <div class="price-box">
                                 <p class="special-price">
                                    ...
                                    <span class="price" id="product-price-16">S/.288.00</span>
                                </p>
                            </div>
    ...
    <div class="toolbar-bottom">
        ...
        <div class="pager">
            ...
            <div class="pages">
                ...
                <div class="view-mode"><strong>Cuadricula</strong>&nbsp;<a href="#" title="Lista" class="list">Lista</a>&nbsp;
            	</div>
...
<div class="ajax-body-logout">
    <div class="account-login">
        <div class="page-title">
            <h1>&nbsp;</h1>
            <a href="javascript:void(0);" class="a-close-frm" onclick="closeLogoutForm()"><span>Cerrar</span></a>
        </div>
...
<div class="ajax-body-login">
    <div class="account-login">
        <div class="page-title">
            <h1>&nbsp;</h1>
            <a href="javascript:void(0);" class="a-close-frm" onclick="closeLoginForm()"><span>Cerrar</span></a>
        </div>
        <div class="ajax-content">
        </div>
    </div>
