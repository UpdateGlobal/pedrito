...
<div class="container">
    <table class="table table-responsive">
      ...
      <tbody>
        <tr>
          <th><img src="imagenes/pet-1.jpg" width="50px" height="80px" alt="nameP"></th>
          <th><p style="text-align: justify;">Lorem Ipsum es simplemente el texto de relleno de las imprentas y archivos de texto.</p></th>
          <th><input type="text" class="form-control" id="" placeholder="Cantidad" name="" size="1" style="input[type=text]:
                                                                                                      width: 10%;
                                                                                                      padding: 10px 10px;
                                                                                                      margin: 8px 0;
