...
<body class=" cms-index-index cms-ma-fobe-pet-home" style="margin:0px;">
    <div class="wrapper">
        <div class="page">
                        ...
                        <ul>
                            ...
                            <div class="container">
                                    <div class="ma-featured-sldier-title ma-title">
                                        ...
                                        <h5>Las preguntas mas frecuentes realizadas por nuestros usuarios</h5>
                                    </div>
                            <ul class="collapsible popout" data-collapsible="accordion">
                                <li>
                                  <div class="collapsible-header"> Preguntas Frecuentes?</div>
