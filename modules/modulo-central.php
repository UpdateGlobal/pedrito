                                ...
                                <div class="col-module col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    <div class="ma-newproductslider-container ">
                                                    ...
                                                    <div class="item-inner">
                                                        <div class="ma-box-content">
                                                            ...
                                                            <div class="des">
                                                                ...
                                                                <div class="actions">
                                                                    <button type="button" title="Agregar al Carrito" class="button btn-cart" onclick="setLocation('http://www.#')"><span><span>Agregar al Carrito</span></span>
                                                                    </button>
                                        ...
                                        $jq(document).ready(function() {
                                            ...
                                            if ($jq('.product-style1 .owl .owl-controls').length) {
                                                $jq('.product-style1 .owl .owl-controls').appendTo('.col-des');
                                            }
                                        });
                                        </script>
                                    </div>
